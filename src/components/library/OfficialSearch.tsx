      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {searchResults?.map((plugin: any) => {
          ...
          const isAdding =
            ...
            addPluginMutation.variables?.slug === plugin.slug;
